# `mrfDepth_jll.jl` (v1.0.14+0)

[![deps](https://juliahub.com/docs/mrfDepth_jll/deps.svg)](https://juliahub.com/ui/Packages/mrfDepth_jll/OSs2E?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/0eb5e48617c2de4bba00af440aac5ebb389ca6a9/M/mrfDepth/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `mrfDepth_jll.jl` have been built from these sources:

* git repository: https://github.com/cran/mrfDepth.git (revision: `6954d87f8ea3c87a2d945676233bf849af5aacd1`)

## Platforms

`mrfDepth_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `mrfDepth_jll.jl`:
